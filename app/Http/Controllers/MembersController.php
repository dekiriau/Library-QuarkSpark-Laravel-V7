...
class MembersController extends Controller
{
            ...
            return Datatables::of($members)
                ...
                ->addColumn('action', function($member) {
                    return view('datatable._action', [
                        ...
                        'toggleUserUrl'     =>  route('members.status.toggle', $member->id)
                    ]);
                })
                ->addColumn('status', function($member) {
                    return $member->enabled ? 'Aktif' : 'Tidak Aktif';
                })
    ...
    public function statusToggle($memberId, Request $request)
    {
        ...
        if ($member->hasRole('member')) {
            ...
            Session::flash("flash_notification", [
                "level"     =>  "success",
                "message"   =>  "Member status berhasil di tukar"
            ]);
        }
